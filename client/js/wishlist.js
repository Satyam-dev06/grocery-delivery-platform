  ...
  wishlistProducts.forEach(function (product) {
    ...
    wishlistContainer.innerHTML += `
      <div class="product-card">
        <a href="product-details.html?id=${prodId}" class="pd-card-link"><img src="${imgUrl(resolveProductImage(product))}" alt="${product.name}" onerror="this.style.display='none'"></a>
